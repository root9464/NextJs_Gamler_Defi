...
export const UserCameraFrame: FC<UsersCameraFrameProps> = ({ stream }) => {
  return (
    <div
      className={cn(
        'relative flex h-50 w-[332px] shrink-0 flex-col justify-between rounded-[11px] bg-red-300 px-[15px] py-[18px]',
      ...
      <div className='relative rounded-xl border border-red-500'>
        <video
          key={stream.id}
          autoPlay
          ref={(video) => {
