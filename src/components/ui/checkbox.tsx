...
import type { CheckboxGroupProps as CheckboxGroupPrimitiveProps, CheckboxProps as CheckboxPrimitiveProps } from 'react-aria-components';
import { CheckboxGroup as CheckboxGroupPrimitive, Checkbox as CheckboxPrimitive, composeRenderProps } from 'react-aria-components';

import { composeTailwindRenderProps } from '@shared/lib/primitive';
import { Description, FieldError, type FieldProps, Label } from '@ui/field';
...
const Checkbox = ({ className, children, description, label, ...props }: CheckboxProps) => {
  return (
    <CheckboxPrimitive {...props} className={composeTailwindRenderProps(className, 'group block disabled:opacity-50')}>
