...
import { DialogTrigger as DialogTriggerPrimitive, OverlayArrow, Popover as PopoverPrimitive } from 'react-aria-components';
import { DialogBody, DialogClose, DialogDescription, DialogFooter, DialogHeader, DialogTitle, DialogTrigger } from './dialog';
...
const PopoverContent = ({ children, showArrow = false, className, ref, ...props }: PopoverContentProps) => {
...
export { Popover, PopoverBody, PopoverClose, PopoverContent, PopoverDescription, PopoverFooter, PopoverHeader, PopoverTitle, PopoverTrigger };
